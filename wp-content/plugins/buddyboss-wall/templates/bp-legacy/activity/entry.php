			...
			<?php if ( is_user_logged_in() ) : ?>
				...
				<?php if ( bp_activity_can_favorite() ) : ?>
					...
					<?php if ( !bp_get_activity_is_favorite() ) : ?>
						...
						<?php $like_count = bp_activity_get_meta( bp_get_activity_id(), 'favorite_count' ); ?>

						<a href="<?php bp_activity_favorite_link(); ?>" class="button fav bp-secondary-action"><?php _e( 'Favorite', 'buddypress' ); ?>
							<span class="likes-count"><?php echo empty( $like_count ) ? 0 : 1; ?></span>
						</a>

					<?php else : ?>

						<a href="<?php bp_activity_unfavorite_link(); ?>" class="button unfav bp-secondary-action"><?php _e( 'Remove Favorite', 'buddypress' ); ?>
							<span class="likes-count"><?php echo bp_activity_get_meta( bp_get_activity_id(), 'favorite_count' ); ?></span>
						</a>
