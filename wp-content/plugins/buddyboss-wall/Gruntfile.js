...
module.exports = function ( grunt ) {
    ...
    grunt.initConfig( {
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/buddyboss-wall.min.js': [ 'assets/js/buddyboss-wall.js' ],
                    'assets/js/buddyboss-wall-nouveau.min.js': [ 'assets/js/buddyboss-wall-nouveau.js' ],
                    'assets/js/buddyboss-wall-privacy.min.js': [ 'assets/js/buddyboss-wall-privacy.js' ],
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddyboss-wall', 'buddypress', 'bbpress', 'buddypress-inbox', 'buddyboss-media', 'buddyboss-welcome-experience' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddyboss-wall.pot', // Name of the POT file.
