...
class WCVendors_Pro_Product_Form {
	...
	public function product_max_gallery_count( $gallery_options ){
    	...
    	$gallery_options[ 'max_upload' ] = get_option( 'wcvendors_product_max_gallery_count' );
	...
	public static function description( $post_id, $product_description ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_description' ) ) {

			$custom_attributes = 'yes' === get_option( 'wcvendors_required_product_basic_description' ) ? array(  'required' => '', 'data-parsley-error-message' => __( 'Product description is required.', 'wcvendors-pro' ) ) : array();
	...
	public static function short_description( $post_id, $product_short_description ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_short_description' ) ) {

			$custom_attributes = 'yes' === get_option( 'wcvendors_required_product_basic_short_description' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Product short description is required.', 'wcvendors-pro' ) ) : array();
	...
	public static function categories( $post_id, $multiple = false ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_categories' ) ) {

			if ( get_option( 'wcvendors_category_display' ) == 'select' ) {
	...
	public static function categories_dropdown( $post_id, $multiple = false ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_categories' ) ) {
			...
			$required_field = 'yes' === get_option( 'wcvendors_required_product_basic_categories' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Please select a category.', 'wcvendors-pro' )  ) : array();
			...
			$custom_attributes = array_merge( $required_field, $custom_attributes );
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_attributes' ) ) {
			...
			if ( !empty( $attribute_taxonomies ) ) {
				...
				foreach ( $attribute_taxonomies as $product_attribute ) {
					...
					if ( in_array( $product_attribute->attribute_id, explode( ',', get_option( 'wcvendors_hide_attributes_list' ) ) ) ) continue;
	...
	public static function tags( $post_id, $multiple = false ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_tags' ) ) {
	...
	public static function tags_select( $post_id, $multiple = false ) {
		...
		$required_field 	= 'yes' === get_option( 'wcvendors_hide_product_basic_tags' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Please select a tag.', 'wcvendors-pro' )  ) : array();
		$custom_attributes 	= array(
	...
	public static function product_type( $post_id ) {
		...
		$product_type_settings = get_option( 'wcvendors_capability_product_types' );
		...
		// Disable capabitilies based on settings
		$product_type_options_settings = (array) get_option( 'wcvendors_capability_product_type_options' );
		...
		foreach ( $product_type_options as $key => $option ) {
			...
			if ( version_compare( WC_VERSION, '3.0', '<' ) ) {
				$selected_value = ( $selected_value ) ? 'yes' : 'no';
				$checked_value = 'yes';
			}
			...
			$type_box .= '<li class="'. esc_attr( $option['wrapper_class'] ) . ' "><input type="checkbox" name="' . esc_attr( $option['id'] ) . '" id="' . esc_attr( $option['id'] ) . '" ' . checked( $selected_value,  $checked_value, false ) .' /><label for="' . esc_attr( $option['id'] ) . '" class="'. esc_attr( $option['wrapper_class'] ) . ' " data-tip="' . esc_attr( $option['description'] ) . '">' . esc_html( $option['label'] ) . '</label></li>';
		}
	...
	public static function price( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_price' ) ) {

			$required_field 	= 'yes' === get_option( 'wcvendors_required_product_general_price' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Price is required', 'wcvendors-pro' )  ) : array();
			$custom_attributes 	= array( 'data-parsley-type' => 'number' );
			$custom_attributes 	= array_merge( $custom_attributes, $required_field );

			$wrapper_start 	= 'yes' != get_option( 'wcvendors_hide_product_general_sale_price' ) ? '<div class="wcv-cols-group wcv-horizontal-gutters"><div class="all-50 small-100">' : '<div class="all-100">';
	...
	public static function sale_price( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_price' ) && 'yes' != get_option( 'wcvendors_hide_product_general_sale_price' ) ) {

			$required_field 	= 'yes' === get_option( 'wcvendors_required_product_general_sale_price' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Sale price is required', 'wcvendors-pro' )  ) : array();
			$custom_attributes 	= array( 'data-parsley-type' => 'number' );
			$custom_attributes 	= array_merge( $custom_attributes, $required_field );
	...
	public static function download_files( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_download_files' ) ) {

			$readonly 			= get_option( 'wcvendors_hide_product_general_download_file_url' ) ? 'readonly' : '';
	...
	public static function product_attributes( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_basic_attributes' ) ) {
			...
			$form_caps = (array) get_option( 'wcvendors_product_form_cap' );
	...
	public static function download_limit( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_download_files' ) && 'yes' != get_option( 'wcvendors_hide_product_general_download_limit' ) ) {

			$required_field 	= 'yes' === get_option( 'wcvendors_required_product_general_download_limit' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Download limit is required', 'wcvendors-pro' )  ) : array();
			$custom_attributes 	= array( 'data-parsley-type' => 'number' );
			$custom_attributes 	= array_merge( $custom_attributes, $required_field );

			$wrapper_start 	= 'yes' === get_option( 'wcvendors_hide_product_general_download_expiry' ) ? '<div class="all-100">' : '<div class="wcv-cols-group wcv-horizontal-gutters"><div class="all-50 small-100">';
	...
	public static function download_expiry( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_download_files' ) && 'yes' != get_option( 'wcvendors_hide_product_general_download_expiry' ) ) {


			$required_field 	= 'yes' === get_option( 'wcvendors_required_product_general_download_expiry' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Download expiry is required.', 'wcvendors-pro' )  ) : array();
			$custom_attributes 	= array( 'data-parsley-type' => 'number' );
			$custom_attributes 	= array_merge( $custom_attributes, $required_field );


			$wrapper_start 	= ( 'yes' != get_option( 'wcvendors_hide_product_general_download_limit' ) ) ? '<div class="all-50 small-100">' : '<div class="all-100">';
			$wrapper_end 	= ( 'yes' != get_option( 'wcvendors_hide_product_general_download_limit' ) ) ? '</div></div>' : '</div>';
	...
	public static function download_type( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_download_files' ) && 'yes' != get_option( 'wcvendors_hide_product_general_download_type' ) ) {

			$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_general_download_type' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Download type is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function sku( $post_id ) {
		...
		$sku_disabled = ( 'yes' !== get_option( 'wcvendors_capability_product_sku' ) ) ? false : true;

		if ( !$sku_disabled && 'yes' != get_option( 'wcvendors_hide_product_general_sku' ) ) {

			if ( wc_product_sku_enabled() ) {

				$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_general_sku' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'SKU is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function private_listing( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_private_listing' ) ) {

			$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_general_private_listing' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Private listing is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function external_url( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_external_url' ) ) {

			$custom_attributes 	= get_option( 'wcvendors_required_product_general_external_url' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'External URL is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function button_text( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_button_text' ) ) {

			$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_general_button_text' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Button text is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function tax( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_general_tax' ) ) {

			if ( wc_tax_enabled() ) {

				$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_general_tax' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Tax is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function manage_stock( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_inventory_manage_inventory' ) ) {

			$custom_attributes 	= 'yes' != get_option( 'wcvendors_required_product_inventory_manage_inventory' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Manage stock is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function stock_qty( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_inventory_manage_inventory' ) && 'yes' != get_option( 'wcvendors_hide_product_inventory_stock_qty' ) ) {

			$custom_attributes 	= 'yes' != get_option( 'wcvendors_required_product_inventory_stock_qty' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Stock QTY is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function backorders( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_inventory_manage_inventory' ) && 'yes' != get_option( 'wcvendors_hide_product_inventory_backorders' ) ) {

			$custom_attributes 	= 'yes' != get_option( 'wcvendors_required_product_inventory_backorders' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Allow backorders is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function stock_status( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_inventory_manage_inventory' ) && 'yes' != get_option( 'wcvendors_hide_product_inventory_stock_status' ) ) {

			$custom_attributes 	= 'yes' != get_option( 'wcvendors_required_product_inventory_stock_status' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Stock status is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function sold_individually( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_inventory_manage_inventory' ) && 'yes' != get_option( 'wcvendors_hide_product_inventory_sold_individually' ) ) {

			$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_inventory_sold_individually' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Sold individually  is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function weight( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_shipping_weight' ) ) {

			if ( wc_product_weight_enabled() ) {

				$custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_shipping_weight' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Weight is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function dimensions( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_shipping_dimensions' ) ) {
			...
			if ( wc_product_dimensions_enabled() ) {
				...
				$length_custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_shipping_dimensions' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Length is required.', 'wcvendors-pro' )  ) : array();
				...
				$width_custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_shipping_dimensions' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Width is required.', 'wcvendors-pro' )  ) : array();
				...
				$height_custom_attributes 	= 'yes' === get_option( 'wcvendors_required_product_shipping_dimensions' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Height is required.', 'wcvendors-pro' )  ) : array();
	...
	public static function shipping_class( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_shipping_shipping_class' ) ) {
	...
	public static function up_sells( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_upsells_up_sells' ) ) {
			...
			$required_field = 'yes' === get_option( 'wcvendors_required_product_upsells_up_sells' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Please select a product.', 'wcvendors-pro' )  ) : array();
	...
	public static function crosssells( $post_id ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_upsells_crosssells' ) ) {
			...
			$required_field = 'yes' === get_option( 'wcvendors_required_product_upsells_crosssells' ) ? array( 'required' => '', 'data-parsley-error-message' => __( 'Please select a product.', 'wcvendors-pro' )  ) : array();
	...
	public static function grouped_products( $post_id, $product = false ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_upsells_grouped_products' ) ) {
			...
			$custom_attributes = array(
					...
					'data-action'		=> 'wcv_json_search_products',
					'data-multiple' 	=> 'true',
					'data-selected'		=> esc_attr( json_encode( $grouped_products ) )
				);


			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_product_grouped_products', array(
					'id' 					=> 'grouped_products',
	...
	public static function product_meta_tabs( ) {
		...
		$wcv_product_panel 			= get_option( 'wcvendors_capability_product_data_tabs' );
		...
		if ( 'yes' === get_option( 'wcvendors_hide_product_inventory_manage_inventory' ) ) { unset( $product_meta_tabs[ 'inventory' ] ); }
		if ( 'yes' === get_option( '') ) { unset( $product_meta_tabs[ 'shipping' ] );  }
		if ( 'yes' === get_option( 'wcvendors_hide_product_upsells_up_sells' ) && 'yes' === get_option( 'wcvendors_hide_product_upsells_cross_sells' ) ) { unset( $product_meta_tabs[ 'linked_product' ] ); }
		if ( 'yes' === get_option( 'wcvendors_hide_product_basic_attributes' ) ) { unset( $product_meta_tabs[ 'attributes' ] ); }
	...
	public static function handling_fee( $shipping_details ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_shipping_handling_fee' ) ) {
	...
	public static function max_charge( $shipping_details ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_shipping_max_charge' ) ) {
	...
	public static function free_shipping_product( $shipping_details ) {
		...
		if ( 'yes' != get_option( 'wcvendors_hide_product_shipping_free_shipping_product' ) ) {
	...
	public static function product_variations( $post_id ){
		...
		$basic_options 			= (array) get_option( 'wcvendors_hide_product_basic' );
		$media_options 			= (array) get_option( 'wcvendors_hide_product_media' );
		$general_options 		= (array) get_option( 'wcvendors_hide_product_general' );
		$inventory_options 		= (array) get_option( 'wcvendors_hide_product_inventory' );
		$shipping_options 		= (array) get_option( 'wcvendors_hide_product_shipping' );
		$upsell_options 		= (array) get_option( 'wcvendors_hide_product_upsells' );
