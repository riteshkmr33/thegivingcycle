...
class WCVendors_Pro_Store_Form {
	...
	*/
	...
	public static function store_form_tabs(){
		...
		if ( 'yes' === get_option( 'wcvendors_hide_signup_tab_payment' ) ) 	$hide_tabs_signup[] = 'payment';
		if ( 'yes' === get_option( 'wcvendors_hide_signup_tab_branding' ) ) $hide_tabs_signup[] = 'branding';
		if ( 'yes' === get_option( 'wcvendors_hide_signup_tab_shipping' ) ) $hide_tabs_signup[] = 'shipping';
		if ( 'yes' === get_option( 'wcvendors_hide_signup_tab_social' ) ) 	$hide_tabs_signup[] = 'social';
		if ( 'yes' === get_option( 'wcvendors_hide_signup_tab_seo' ) ) 	$hide_tabs_signup[] = 'seo';

		if ( 'yes' === get_option( 'wcvendors_hide_settings_tab_payment' ) ) 	$hide_tabs_settings[] = 'payment';
		if ( 'yes' === get_option( 'wcvendors_hide_settings_tab_branding' ) ) 	$hide_tabs_settings[] = 'branding';
		if ( 'yes' === get_option( 'wcvendors_hide_settings_tab_shipping' ) ) 	$hide_tabs_settings[] = 'shipping';
		if ( 'yes' === get_option( 'wcvendors_hide_settings_tab_social' ) ) 	$hide_tabs_settings[] = 'social';
		if ( 'yes' === get_option( 'wcvendors_hide_settings_tab_seo' ) ) 	$hide_tabs_settings[] = 'seo';

		$hide_tabs = ( self::$form_type ) ? $hide_tabs_signup : $hide_tabs_settings;

		$shipping_disabled			= get_option( 'wcvendors_shipping_management_cap' );
	...
	public static function store_banner( ) {
		...
		$branding  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_branding_store_banner' ) : get_option( 'wcvendors_hide_settings_branding_store_banner' ) ;
	...
	public static function store_icon( ) {
		...
		$branding  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_branding_store_icon' ) : get_option( 'wcvendors_hide_settings_branding_store_icon' ) ;
	...
	public static function paypal_address(  ) {
		...
		$payment   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_paypal' ) : get_option( 'wcvendors_hide_settings_payment_paypal' ) ;
	...
	public static function bank_account_name(  ) {
		...
		$bank_account_name   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_bank_account_name' ) : get_option( 'wcvendors_hide_settings_payment_bank_account_name' ) ;
		...
		if ( 'yes' !== $bank_account_name ) {
			...
			// Paypal address
			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_bank_account_name', array(
	...
	public static function bank_account_number(  ) {
		...
		$bank_account_number   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_bank_account_number' ) : get_option( 'wcvendors_hide_settings_payment_bank_account_number' ) ;
		...
		if ( 'yes' !== $bank_account_number ) {
			...
			// Paypal address
			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_bank_account_number', array(
	...
	public static function bank_name(  ) {
		...
		$bank_name   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_bank_name' ) : get_option( 'wcvendors_hide_settings_payment_bank_name' ) ;
		...
		if ( 'yes' !== $bank_name ) {
			...
			// Paypal address
			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_bank_name', array(
				'id' 				=> 'wcv_bank_name',
	...
	public static function bank_routing_number(  ) {
		...
		$bank_routing_number   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_routing_number' ) : get_option( 'wcvendors_hide_settings_payment_routing_number' ) ;
		...
		if ( 'yes' !== $bank_routing_number ) {
			...
			// Paypal address
			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_bank_routing_number', array(
	...
	public static function bank_iban(  ) {
		...
		$bank_iban   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_iban' ) : get_option( 'wcvendors_hide_settings_payment_iban' ) ;
	...
	public static function bank_bic_swift(  ) {
		...
		$bank_bic_swift   = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_payment_bic_swift' ) : get_option( 'wcvendors_hide_settings_payment_bic_swift' ) ;
		...
		if ( 'yes' !== $bank_bic_swift ) {
			...
			// Paypal address
			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_bank_bic_swift', array(
	...
	public static function store_phone( ) {
		...
		$store    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_store_phone' ) : get_option( 'wcvendors_hide_settings_store_phone' ) ;
	...
	public static function seller_info( ) {
		...
		$store    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_store_seller_info' ) : get_option( 'wcvendors_hide_settings_store_seller_info' ) ;
		...
		if ( 'yes' !== $store ) {
			...
			$store_wide_html 	= get_option( 'wcvendors_shop_html_enabled' );
	...
	public static function store_description( ) {
		...
		$store    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_store_description' ) : get_option( 'wcvendors_hide_settings_store_description' );
	...
	public static function store_address_country( ) {
		...
		$store    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_store_address' ) : get_option( 'wcvendors_hide_settings_store_address' );
	...
	public static function company_url(  ) {
		...
		$store    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_store_company_url' ) : get_option( 'wcvendors_hide_settings_store_company_url' ) ;
	...
	public static function twitter_username(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_twitter' ) : get_option( 'wcvendors_hide_settings_social_twitter' ) ;
	...
	public static function instagram_username(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_instagram' ) : get_option( 'wcvendors_hide_settings_social_instagram' ) ;
	...
	public static function facebook_url(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_facebook' ) : get_option( 'wcvendors_hide_settings_social_facebook' ) ;
	...
	public static function linkedin_url(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_linkedin' ) : get_option( 'wcvendors_hide_settings_social_linkedin' ) ;
	...
	public static function youtube_url(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_youtube' ) : get_option( 'wcvendors_hide_settings_social_youtube' ) ;
	...
	public static function googleplus_url(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_google_plus' ) : get_option( 'wcvendors_hide_settings_social_google_plus' ) ;
	...
	public static function pinterest_url(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_pinterest' ) : get_option( 'wcvendors_hide_settings_social_pinterest' ) ;
	...
	public static function snapchat_username(  ) {
		...
		$social    = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_social_snapchat' ) : get_option( 'wcvendors_hide_settings_social_snapchat' ) ;
	...
	public static function shipping_fee_national( $shipping_details ) {
		...
		WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_shipping_national_fee', array(
			...
			'custom_attributes' => array(
		 			...
		 			'data-parsley-error-message' => __( 'This should be a number.', 'wcvendors-pro' )
	...
	public static function product_handling_fee( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_handling_fee' ) : get_option( 'wcvendors_hide_settings_shipping_handling_fee' );
	...
	public static function order_min_charge( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_min_charge' ) : get_option( 'wcvendors_hide_settings_shipping_min_charge' );
	...
	public static function order_max_charge( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_max_charge' ) : get_option( 'wcvendors_hide_settings_shipping_max_charge' );
	...
	public static function free_shipping_order( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_free_shipping_order' ) : get_option( 'wcvendors_hide_settings_shipping_free_shipping_order' );
	...
	public static function free_shipping_product( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_free_shipping_product' ) : get_option( 'wcvendors_hide_settings_shipping_free_shipping_product' );
	...
	public static function product_max_charge( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_max_charge_product' ) : get_option( 'wcvendors_hide_settings_shipping_max_charge_product' );
	...
	public static function shipping_policy( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_shipping_policy' ) : get_option( 'wcvendors_hide_settings_shipping_shipping_policy' );
	...
	public static function return_policy( $shipping_details ) {
		...
		$shipping  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_shipping_return_policy' ) : get_option( 'wcvendors_hide_settings_shipping_return_policy' );
	...
	public static function vacation_mode( ) {
		...
		if ( ! get_option( 'wcvendors_hide_settings_store_vacation_mode' ) ) {
		...
		if ( ( $terms_page )  &&  ( ! isset( $_GET['terms'] ) ) ){
			...
			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_terms_args', array(
						...
						'custom_attributes' => array(
							...
							'data-parsley-error-message'	=> __('You must agree to the terms and conditions to apply to be a vendor.', 'wcvendors-pro' ),
							),
						)
					)
			);
	...
	*/
	public static function seo_title( ){
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_title' ) : get_option( 'wcvendors_hide_settings_seo_title' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_title', true );

			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_seo_title', array(
				'id' 				=> 'wcv_seo_title',
	...
	*/
	public static function seo_meta_description( ){
		...
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_meta_description' ) : get_option( 'wcvendors_hide_settings_seo_meta_description' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_meta_description', true );

			WCVendors_Pro_Form_Helper::textarea( apply_filters( 'wcv_vendor_seo_meta_description', array(
	...
	*/
	public static function seo_meta_keywords( ){
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_meta_keywords' ) : get_option( 'wcvendors_hide_settings_seo_meta_keywords' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_meta_keywords', true );

			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_seo_meta_keywords', array(
	...
	*/
	public static function seo_fb_title( ){
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_fb_title' ) : get_option( 'wcvendors_hide_settings_seo_fb_title' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_fb_title', true );

			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_seo_fb_title', array(
				'id' 				=> 'wcv_seo_fb_title',
	...
	*/
	public static function seo_fb_description( ){
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_fb_description' ) : get_option( 'wcvendors_hide_settings_seo_fb_description' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_fb_description', true );

			WCVendors_Pro_Form_Helper::textarea( apply_filters( 'wcv_vendor_seo_fb_description', array(
	...
	*/
	public static function seo_fb_image( ){
		...
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_fb_image' ) : get_option( 'wcvendors_hide_settings_seo_fb_image' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_fb_image_id', true );

			WCVendors_Pro_Form_Helper::file_uploader( apply_filters( 'wcv_vendor_seo_fb_image', array(
	...
	*/
	public static function seo_twitter_title( ){
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_twitter_title' ) : get_option( 'wcvendors_hide_settings_seo_twitter_title' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_twitter_title', true );

			WCVendors_Pro_Form_Helper::input( apply_filters( 'wcv_vendor_seo_twitter_title', array(
	...
	*/
	public static function seo_twitter_description( ){
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_twitter_description' ) : get_option( 'wcvendors_hide_settings_seo_twitter_description' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_twitter_description', true );

			WCVendors_Pro_Form_Helper::textarea( apply_filters( 'wcv_vendor_seo_twitter_description', array(
	...
	*/
	public static function seo_twitter_image( ){
		...
		$seo_option  = ( self::$form_type ) ? get_option( 'wcvendors_hide_signup_seo_twitter_image' ) : get_option( 'wcvendors_hide_settings_seo_twitter_image' );

		if ( 'yes' !== $seo_option ){

			$value 		= get_user_meta( get_current_user_id(), 'wcv_seo_twitter_image_id', true );

			WCVendors_Pro_Form_Helper::file_uploader( apply_filters( 'wcv_vendor_seo_twitter_image', array(
