...
<div class="wcv_variation wcv-metabox closed all-100" rel="<?php echo esc_attr( $variation_id ); ?>" data-loop="<?php echo $loop; ?>">
	...
	<div class="wcv_variable_attributes wcv-metabox-content" style="display: none;">
			...
			<?php do_action( 'wcv_product_variation_before_general' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_general' ); ?>

			<hr style="clear: both;" />

			<?php do_action( 'wcv_product_variation_before_options' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_options' ); ?>
			...
			<?php do_action( 'wcv_product_variation_before_pricing' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_pricing' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_stock' ); ?>

			<?php do_action( 'wcv_product_variation_before_weight_dimensions' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_weight_dimensions' ); ?>

			<?php do_action( 'wcv_product_variation_before_shipping_class' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_shipping_class' ); ?>

			<?php do_action( 'wcv_product_variation_before_tax_class' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_tax_class' ); ?>
			...
			<?php do_action( 'wcv_product_variation_before_download_files' ); ?>
			...
			<?php do_action( 'wcv_product_variation_after_download_files' ); ?>
	</div>
</div>
