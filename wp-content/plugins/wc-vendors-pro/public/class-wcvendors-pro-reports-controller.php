...
class WCVendors_Pro_Reports_Controller {
	...
	public function __construct( $wcvendors_pro, $version, $debug ) {
		...
		$this->start_date 		= ( !empty( $_SESSION[ 'PV_Session' ][ '_wcv_dashboard_start_date_input' ] ) ) 	? $_SESSION[ 'PV_Session' ][ '_wcv_dashboard_start_date_input' ] : strtotime( apply_filters( 'wcv_dashboard_start_date', $this->default_start ) );
	...
	public function display() {
		...
		wc_get_template( 'dashboard.php', array(
							'store_report'			=> $this ,
							'products_disabled' 	=> get_option( 'wcvendors_product_management_cap' ),
							'orders_disabled' 		=> get_option( 'wcvendors_order_management_cap' ) ),
	...
	public function recent_orders_table( ){
		...
		$shipping_disabled		= get_option( 'wcvendors_shipping_management_cap', true );
