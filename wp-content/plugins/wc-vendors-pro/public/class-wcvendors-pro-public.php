...
class WCVendors_Pro_Public {
	...
	public function enqueue_styles() {
		...
		$disable_select2 	= 'yes' === get_option( 'wcvendors_disable_select2' ) ? true: false;
	...
	public function enqueue_scripts() {
		...
		$tag_separator 				= get_option( 'tag_separator' );
		$disable_select2 			= 'yes' === get_option( 'wcvendors_disable_select2' ) ? true : false;
		$view_dashboard				= apply_filters( 'wcv_view_dashboard', 	$current_page_id == $dashboard_page_id ? true : false );
		...
		if ( $view_dashboard ) {
			...
			if ( is_user_logged_in() ) {
				...
				$product_params = array(
					...
					'require_featured_image'				=> 'yes' === get_option( 'wcvendors_required_product_media_featured' ) ? true : false,
					'require_featured_image_msg'			=> apply_filters( 'wcv_require_featured_image_msg', __( 'Featured image is required.', 'wcvendors-pro' ) ),
					'require_gallery_image'					=> 'yes' === get_option( 'wcvendors_required_product_media_gallery' ) ? true : false,
					'require_gallery_image_msg'				=> apply_filters( 'wcv_require_featured_image_msg', __( 'A gallery image is required.', 'wcvendors-pro' ) ),
					'require_category'						=> 'yes' === get_option( 'wcvendors_required_product_basic_categories' ) ? true : false,
					'require_category_msg'					=> apply_filters( 'wcv_require_category_msg', __( 'A category is required.', 'wcvendors-pro' ) ),
					'require_download_file'					=> 'yes' === get_option( 'wcvendors_hide_product_general_download_files' ) ? true : false,
					'require_download_file_msg'				=> apply_filters( 'wcv_require_download_file_msg', __( 'A download file is required.', 'wcvendors-pro' ) ),
					'require_attributes'					=> 'yes' === get_option( 'wcvendors_required_product_basic_attributes' ) ? true : false,
