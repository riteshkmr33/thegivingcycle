...
$verified_vendor_label 		= get_option( 'wcvendors_verified_vendor_label' );
		...
		<div id="banner-wrap">
			...
			<div id="inner-element">
			    ...
			    <?php endif; ?>
				   	...
				   	<?php if ( ! get_option( 'wcvendors_ratings_management_cap' ) ) echo WCVendors_Pro_Ratings_Controller::ratings_link( $vendor_id, true ); ?>
...
<div class="wcv-store-address-container wcv-store-grid ">
	...
	<div class="wcv-store-grid__col wcv-store-grid__col--3-of-4 store-address">
