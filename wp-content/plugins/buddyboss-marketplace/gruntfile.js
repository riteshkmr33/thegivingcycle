    ...
    grunt.initConfig( {
        ...
        rtlcss: {
            bbTask: {
                ...
                cwd: 'assets/css/',
                dest: 'assets/css/',
                src: [ '**/buddyboss-marketplace.css', '**/ink.rtl.min.css' ],
                ext: '-rtl.css'
            }
        },
        /*
        ...
        uglify: {
            ...
            frontend: {
                files: {
                    'assets/js/buddyboss-marketplace.min.js': [ 'assets/js/buddyboss-marketplace.js' ],
                }
            },
        },
        /*
        ...
        checktextdomain: {
            options: {
                text_domain: [ 'buddyboss-marketplace', 'buddypress', 'bbpress', 'buddypress-inbox', 'wcvendors-pro', 'wc-vendors', 'woocommerce', 'boss-sensei' ], //Specify allowed domain(s)
        ...
        makepot: {
            target: {
                options: {
                    ...
                    potFilename: 'buddyboss-marketplace.pot', // Name of the POT file.
