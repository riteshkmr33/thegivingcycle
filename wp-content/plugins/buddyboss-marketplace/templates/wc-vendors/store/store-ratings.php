...
get_header( 'shop' ); ?>
    ...
    <div class="bm-store-ratings">
        <h1 class="page-title"><?php _e( 'Customer Ratings', 'buddyboss-marketplace' ); ?></h1>
        ...
        <?php if ( $vendor_feedback ) {
            ...
            foreach ( $vendor_feedback as $vf ) {
                ...
                <p><?php _e( 'Product:', 'buddyboss-marketplace'); ?><a href="<?php echo $product_link; ?>" target="_blank"><?php echo $product_title; ?></a></p>
                <span><?php __( 'Posted on', 'buddyboss-marketplace'); ?> <?php echo $post_date; ?></span> <?php __( 'by', 'buddyboss-marketplace'); echo $customer_name; ?><br />
        ...
        } else {  echo __( 'No ratings have been submitted for this vendor yet.', 'buddyboss-marketplace' ); }  ?>

        <h3><a href="<?php echo $vendor_shop_url; ?>"><?php _e( 'Return to store', 'buddyboss-marketplace' ); ?></a></h3>
