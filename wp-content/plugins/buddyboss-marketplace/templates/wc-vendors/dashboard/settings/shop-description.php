<div id="pv_shop_description_container">
	<p>
		<label><?php _e( 'Shop Description', 'buddyboss-marketplace' ); ?></label>
		<span><?php printf( __( 'This is displayed on your <a href="%s">shop page</a>.', 'buddyboss-marketplace' ), $shop_page ); ?></span>
	</p>
