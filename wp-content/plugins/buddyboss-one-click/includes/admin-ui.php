...
class buddyboss_oneclick_installer {
    ...
    var $admin_screen = '';
    var $package_api = 'https://s3.us-east-2.amazonaws.com/bboneclick/oneclick/packages.txt';
    ...
    function get_all_demo_packages() {
        ...
        $reponse = wp_remote_get( $this->package_api );
        if( is_wp_error( $reponse ) || ( $reponse['response']['code'] != 200 ) )
            return false;
