...
* Fix - Admin bar is showing up for non-admin users too
* Fix - Delay notifications, the notification shows after refreshing page 
* Fix - Post section remains open after posting an activity
* Fix - Group cover photo scrolling issue
* Fix - BuddyPress Message - Sent count not getting decreased after deleting the message
* Fix - Uncaught TypeError: Cannot read property 'length' in the console when BP Message component is disabled
* Fix - Add/Cancel Friendship button not showing on IE
* Fix - Styling issue on Member profile edit page
* Fix - BuddyBoss Inbox plugin related fixes
* Fix - Missing My Profile menu items in mobile view
* Tweak - Single/Create docs page style improvements
* Fix - Double cross icon on BP notice bar
* Fix - Fatal error on member setting page with BuddyPress 3.0
* Fix - Conflict between OneSocial child theme and Wall plugin

= 1.4.5 =
* Fix - Fatal error on topic page when BuddyPress is not active
* New - Declare BuddyPress Legacy template pack support

= 1.4.4 =
* Tweak - Close right menu on mobile when user click on the menu item
* Fix - JavaScript error in old browsers due to use of es6 function
* Fix - Service widget does not save when html tags added
* Fix - Translation fixes
* Fix - Notification dropdown menu on window edge
* New - Updated fontawesome version

= 1.4.3 =
* New - Added ability to exclude inputs from Form Inputs JavaScript
* Fix - BuddyPress Global Search not working when product searched
* Fix - Fix mobile styling of Product search
* Fix - Made links clickable in the search result page
* Fix - Removed duplicate description from the registration form
* Fix - Allow link option in editor while composing a message
* Fix - Corrected translation textdomain

= 1.4.2 =
* Fix - Members can not register from the overlay register popup
* Fix - Conflict between Select2 and OneSocial responsive dropdown

= 1.4.1 =
* Fix - New members cannot register
* Fix - bookmark tabs under user profile
* Fix - Recommended link not working for guest users
* Fix - Words counts style tweaks
* Fix - Post saved as draft always from home or blog index page using user blog plugin
* Fix - User Blog style tweak
