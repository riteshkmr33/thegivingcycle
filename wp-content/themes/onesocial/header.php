...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?> data-inputs="<?php echo $inputs; ?>">
		...
		<div id="main-wrap">
			...
			<?php
			$show_single_header	 = apply_filters( 'onesocial_single_header', ( is_single() && !( function_exists( 'is_bbpress' ) && is_bbpress() ) && !( function_exists( 'is_product' ) && is_product() ) && !( function_exists( 'WPJM' ) && get_post_type() === 'job_listing' ) ) );
